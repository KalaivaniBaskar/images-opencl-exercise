...
{   
    ...
    const int opM = ((M - 3)/ stride ) + 1;
    const int opN = ((N - 3)/ stride ) + 1;
        ...
        const char* kernelSource = R"(
            ...
            if( gidI < M-2 && gidJ < N-2 && gidK < O-2) {
               ...
               int sum =0; 
                ...
                for (int m = gidI * stride; m < h; ++m) {
                    for (int n = gidJ * stride; n < w; ++n) {
                ...
                for(int b = 0; b < 27; ++b){
                    ...
                    // printf("for %d %d %d, inp is %d , filt is %d \n", gidI, gidJ,gidK, inp[b],filter[b]);
                }
...
//  */
        ...
        auto cnv3 = cl::make_kernel<cl::Buffer, cl::Buffer, cl::Buffer, int, int, int, int>(program, "cnv3");
